...
void MidPoint_Ellipse::fourFloodFill(int x, int y, unsigned char* fillColor)
{
	unsigned char XYPixelColor[4];
...
//		glFlush();
		...
		fourFloodFill(x+1, y, fillColor);
		fourFloodFill(x-1, y, fillColor);
		glFlush();
		fourFloodFill(x, y+1, fillColor);
		fourFloodFill(x, y-1, fillColor);
//		glFlush();
	}
...
void MidPoint_Ellipse::eightFloodFill(int x, int y, unsigned char* fillColor)
{
	unsigned char XYPixelColor[4];
